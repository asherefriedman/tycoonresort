...
function initGameEngine(container: HTMLDivElement, pendingSave: any, doLoad: boolean, ui: UICallbacks) {
  ...
  const STEPS: any[] = [
    ...
    {id:52,x:244,z:22,cost:2500,label:'Lounger 1',type:'custom',mat:'cobalt',inc:90,w:2.2,h:0.6,d:6,need:51,ox:-8,oz:2,custom:'lounger'},
    {id:53,x:252,z:22,cost:2500,label:'Lounger 2',type:'custom',mat:'cobalt',inc:90,w:2.2,h:0.6,d:6,need:52,ox:-4,oz:2,custom:'lounger'},
    {id:54,x:260,z:22,cost:2500,label:'Lounger 3',type:'custom',mat:'cobalt',inc:90,w:2.2,h:0.6,d:6,need:53,ox:4,oz:2,custom:'lounger'},
    {id:55,x:268,z:22,cost:2500,label:'Lounger 4',type:'custom',mat:'cobalt',inc:90,w:2.2,h:0.6,d:6,need:54,ox:8,oz:2,custom:'lounger'},
    {id:56,x:248,z:28,cost:1800,label:'Umbrella 1',type:'custom',mat:'terracotta',inc:60,w:1,h:5.5,d:1,need:55,ox:-6,oz:6,custom:'umbrella'},
    {id:57,x:264,z:28,cost:1800,label:'Umbrella 2',type:'custom',mat:'terracotta',inc:60,w:1,h:5.5,d:1,need:56,ox:6,oz:6,custom:'umbrella'},
